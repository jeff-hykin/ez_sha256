import { toUint8Array, fromUint8Array } from "https://deno.land/x/base64@v0.2.1/base64url.ts"
...
function toHexString(buf: Uint8Array): string {
    return buf.reduce((hex: string, byte: number): string => `${hex}${byte < 16 ? "0" : ""}${byte.toString(16)}`, "")
}
